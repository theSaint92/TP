...
namespace WarstwaUslug
{
    ...
    partial void DeletePlayGames(PlayGames instance);
		...
		public DataBaseDataContext() : 
				base(global::WarstwaUslug.Properties.Settings.Default.CasinoConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Clients : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _DataOfBirth;
    ...
    partial void OnDataOfBirthChanging(System.Nullable<System.DateTime> value);
    partial void OnDataOfBirthChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DataOfBirth", DbType="DateTime")]
		public System.Nullable<System.DateTime> DataOfBirth
		{
			get
			{
			...
			set
			{
				if ((this._DataOfBirth != value))
				{
					this.OnDataOfBirthChanging(value);
					this.SendPropertyChanging();
					this._DataOfBirth = value;
					this.SendPropertyChanged("DataOfBirth");
					this.OnDataOfBirthChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Clients_Participations", Storage="_Participations", ThisKey="Id", OtherKey="Client")]
    ...
    partial void OnGameDescriptionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GameName", DbType="NChar(20)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GameDescription", DbType="NChar(20)")]
    ...
    partial void OnProfitChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Clients_Participations", Storage="_Clients", ThisKey="Client", OtherKey="Id", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PlayGames_Participations", Storage="_PlayGames", ThisKey="PlayedGames", OtherKey="Id", IsForeignKey=true)]
		public PlayGames PlayGames
		{
			...
			set
			{
							...
							|| (this._PlayGames.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Participations.Add(this);
						this._PlayedGames = value.Id;
					}
					else
					{
						this._PlayedGames = default(Nullable<int>);
					}
	...
	public partial class PlayGames : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Game;
		
		private System.Nullable<System.DateTime> _StartTime;
		
		private System.Nullable<System.TimeSpan> _Duration;
		
		private System.Nullable<double> _MinimumDeposit;
		
		private System.Nullable<double> _EntryFee;
    ...
    partial void OnIdChanging(int value);
    partial void OnIdChanged();
    partial void OnGameChanging(System.Nullable<int> value);
    partial void OnGameChanged();
    partial void OnStartTimeChanging(System.Nullable<System.DateTime> value);
    partial void OnStartTimeChanged();
    partial void OnDurationChanging(System.Nullable<System.TimeSpan> value);
    partial void OnDurationChanged();
    partial void OnMinimumDepositChanging(System.Nullable<double> value);
    partial void OnMinimumDepositChanged();
    partial void OnEntryFeeChanging(System.Nullable<double> value);
    partial void OnEntryFeeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Game", DbType="Int")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MinimumDeposit", DbType="Float")]
		public System.Nullable<double> MinimumDeposit
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EntryFee", DbType="Float")]
		public System.Nullable<double> EntryFee
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="PlayGames_Participations", Storage="_Participations", ThisKey="Id", OtherKey="PlayedGames")]
		public EntitySet<Participations> Participations
		{
			get
			{
		...
		public Games Games
		{
			...
			set
			{
							...
							|| (this._Games.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Game = default(Nullable<int>);
					}
